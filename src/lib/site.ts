...
export const nav: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    children: [
      ...
      { label: "Our Pastor", href: "/our-pastor", desc: "A personal welcome" },
  ...
  },
  {
    ...
    href: "/ministries",
    children: [
      { label: "Ministries", href: "/ministries", desc: "Find your place to serve" },
      { label: "Services", href: "/services", desc: "Times & weekly activities" },
      { label: "First Timers", href: "/first-timers", desc: "Plan your first visit" },
      { label: "Prayer & Counselling", href: "/prayer", desc: "We'd love to pray with you" },
    ],
  },
  {
    label: "Media",
    ...
    children: [
      ...
      { label: "Watch Live", href: "/media#live", desc: "Live TV & radio" },
  ...
  { label: "Events", href: "/events" },
  {
    ...
    href: "/wofbi",
    children: [
      { label: "WOFBI", href: "/wofbi", desc: "Word of Faith Bible Institute" },
      { label: "Community (CSR)", href: "/csr", desc: "Our impact in Southport" },
    ],
  },
