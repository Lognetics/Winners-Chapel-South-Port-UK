...
export function PrayerForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-white ring-1 ring-navy-900/10 shadow-xl rounded-2xl p-8 text-center sm:p-10">
        ...
        <p className="mt-6 font-display text-2xl text-navy-900">Your request is received.</p>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 rounded-xl bg-navy-900/5 p-4 ring-1 ring-navy-900/10">
